...
public class newTranslateBehavior : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            ManipulationWidgetBehavior.ManipulationDirection.X => Vector3.right,
            ManipulationWidgetBehavior.ManipulationDirection.Y => Vector3.up,
            ManipulationWidgetBehavior.ManipulationDirection.Z => Vector3.forward,
